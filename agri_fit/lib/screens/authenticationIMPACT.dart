...
class AuthImpact extends StatelessWidget{
  AuthImpact({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Impact authentication'),
      ),
      body: Center(
        child: Column(
          ...
          SizedBox(height: 10),
            ElevatedButton(
              onPressed: () async{
                ...
                ScaffoldMessenger.of(context)
                  ..removeCurrentSnackBar()
                  ..showSnackBar(SnackBar(content: Text('Tokens have been deleted')));
              }, 
  ...
  //Obtain JWT token pair from IMPACT and store in sp
